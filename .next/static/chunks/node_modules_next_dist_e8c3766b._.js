...
"[project]/node_modules/next/dist/server/lib/lru-cache.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/next/dist/compiled/events/events.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
"[project]/node_modules/next/dist/compiled/util/util.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
(function() {
    var r = {
        ...
        994: function(r, e, t) {
            ...
            if (u && l && g) {
                n(s, function(r) {
                    var e = new ("TURBOPACK ident replacement", globalThis)[r];
        ...
        490: function(r, e, t) {
            ...
            if (u && p && l) {
                n(s, function(r) {
                    if (typeof ("TURBOPACK ident replacement", globalThis)[r] === "function") {
                        var e = new ("TURBOPACK ident replacement", globalThis)[r];
                        if (!(Symbol.toStringTag in e)) {
                            throw new EvalError("this engine has support for Symbol.toStringTag, but " + r + " does not have the property! Please report this.");
                        }
        ...
        349: function(r, e, t) {
            ...
            r.exports = function availableTypedArrays() {
                return n([
                    ...
                    return typeof ("TURBOPACK ident replacement", globalThis)[r] === "function";
                });
            };
        },
        24: function(r, e, t) {
...
"[project]/node_modules/next/dist/compiled/stream-browserify/index.js [app-client] (ecmascript)": ((__turbopack_context__) => {
...
(function() {
    var e = {
        ...
        709: function(e, t, r) {
            ...
            var o = r(678);
            var s = r(300).Buffer;
            var f = ("TURBOPACK ident replacement", globalThis).Uint8Array || function() {};
        ...
        337: function(e, t, r) {
            ...
            var a = r(678);
            var o = r(300).Buffer;
            var s = ("TURBOPACK ident replacement", globalThis).Uint8Array || function() {};
            function _uint8ArrayToBuffer(e) {
                return o.from(e);
            }
            function _isUint8Array(e) {
        ...
        769: function(e) {
            ...
            function config(e) {
                try {
                    if (!("TURBOPACK ident replacement", globalThis).localStorage) return false;
                } catch (e) {
                    return false;
                }
                var t = ("TURBOPACK ident replacement", globalThis).localStorage[e];
...
"[project]/node_modules/next/dist/server/web/utils.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/node_modules/next/dist/server/lib/mock-request.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const _stream = /*#__PURE__*/ _interop_require_default(__turbopack_context__.r("[project]/node_modules/next/dist/compiled/stream-browserify/index.js [app-client] (ecmascript)"));
...
class MockedResponse extends _stream.default.Writable {
   ...
   */ _implicitHeader() {}
    ...
    getHeader(name) {
        var _this_headers_get;
        return (_this_headers_get = this.headers.get(name)) !== null && _this_headers_get !== void 0 ? _this_headers_get : undefined;
    }
    getHeaders() {
   ...
   */ this.buffers = [];
        var _res_statusCode;
        this.statusCode = (_res_statusCode = res.statusCode) !== null && _res_statusCode !== void 0 ? _res_statusCode : 200;
        var _res_socket;
        this.socket = (_res_socket = res.socket) !== null && _res_socket !== void 0 ? _res_socket : null;
...
function createRequestResponseMocks(param) {
    let { url, headers = {}, method = 'GET', bodyReadable, resWriter, socket = null } = param;
    return {
...
"[project]/node_modules/next/dist/server/lib/dev-bundler-service.js [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const _mockrequest = __turbopack_context__.r("[project]/node_modules/next/dist/server/lib/mock-request.js [app-client] (ecmascript)");
...
class DevBundlerService {
    ...
    async revalidate(param) {
        let { urlPath, revalidateHeaders, opts: revalidateOpts } = param;
        ...
        if (mocked.res.getHeader('x-nextjs-cache') !== 'REVALIDATED' && mocked.res.statusCode !== 200 && !(mocked.res.statusCode === 404 && revalidateOpts.unstable_onlyGenerated)) {
            throw Object.defineProperty(new Error("Invalid response ".concat(mocked.res.statusCode)), "__NEXT_ERROR_CODE", {
                value: "E175",
                enumerable: false,
                configurable: true
            });
...
//# sourceMappingURL=node_modules_next_dist_e8c3766b._.js.map