    ...
    <div className="overflow-y-auto">
      ...
      <div className="flex flex-col gap-3 mb-5 w-[80vw]">
        {products
          ...
          .map((product) => {
            return (
              <div key={product.id} className="bg-white w-[95%] h-[30vh] m-auto flex items-center gap-[3%] pl-4 box-border">
                ...
                <Link href={`/Product/${product.id}`}><p className=" text-xl text-blue-600 underline text-center text-nowrap">View Product</p></Link>
              </div>
            )
          })
        }</div>
