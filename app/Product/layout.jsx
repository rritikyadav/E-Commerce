  ...
  return (
    <>
      ...
      <div className=" relative w-[95%] h-[50vh] bg-red-900 m-auto my-5 pt-2 box-border text-white">
        ...
        <div ref={ref_Container} className=" w-[100%] h-[40vh] pl-2 box-border grid gap-5 grid-flow-col auto-cols-[22.5vw] overflow-hidden overflow-x-auto scroll-smooth snap-align-center">{
          products_1.map((pro) => {
            return (
              <Link key={pro.id} href={`/Product/${pro.id}`}><div className="min-w-[100%] h-[33vh] snap-mandatory hover:scale-102">
